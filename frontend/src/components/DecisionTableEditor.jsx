...
const styles = {
  ...
  tableFrame: { width: '100%', maxHeight: 620, overflow: 'auto', background: '#fff' },
  tableFrameCompact: { width: '100%', maxHeight: 320, overflow: 'auto', background: '#fff' },
  table: { borderCollapse: 'collapse', minWidth: '100%' },
  cell: { minWidth: 140, height: 58, border: '1px solid #93AEB8', padding: 0, background: '#fff' },
  cellActive: { minWidth: 140, height: 58, border: '2px solid #1956D8', padding: 0, background: '#F8FBFF' },
  cellText: { width: '100%', minHeight: 58, boxSizing: 'border-box', border: 'none', outline: 'none', resize: 'vertical', padding: 8, color: '#09222A', fontFamily: 'inherit', fontSize: 13, lineHeight: 1.35, background: 'transparent' },
  cellTextReadOnly: { width: '100%', minHeight: 58, boxSizing: 'border-box', border: 'none', outline: 'none', resize: 'none', padding: 8, color: '#09222A', fontFamily: 'inherit', fontSize: 13, lineHeight: 1.35, background: 'transparent' },
  sideControlCell: { width: 42, border: 'none', padding: '0 0 0 8', verticalAlign: 'middle' },
  bottomControlCell: { height: 40, border: 'none', padding: '8px 0 0', textAlign: 'center' },
  cornerCell: { width: 42, border: 'none' },
  plusButton: { width: 28, height: 28, borderRadius: 6, border: '1px solid #1956D8', background: '#fff', color: '#1956D8', fontWeight: 800, cursor: 'pointer' },
}
